...
internal class AndroServiceTest {
    ...
    inner class CreateUserServiceTests() {
        ...
        fun givenNewUser_whenExistingEmail_thenThrowException() {
            //Declaring expected response and necessary variables used uniquely for this test
            val expectedResponse = AndroException(
            ...
            val actualResponse = Assertions.assertThrows(
                    AndroException::class.java) { androService.createUser(testUserBad) }
    ...
    inner class GetUserServiceTests(){
        ...
        fun givenUserId_whenUserNotExists_thenThrowException(){
            ...
            //Perform test
            val actualResponse = Assertions.assertThrows(
                    AndroException::class.java) { androService.getUser(userIdBad) }
    ...
    inner class UpdateUserServiceTests(){
        ...
        fun givenUserId_whenUserToUpdateNotExists_thenThrowException(){
            ...
            //Perform test
            val actualResponse = Assertions.assertThrows(
                    AndroException::class.java) { androService.updateUser(userIdBad,userUpdate) }
    ...
    inner class DeleteUserServiceTests() {
        ...
        fun givenUserId_whenUserToUpdateNotExists_thenThrowException() {
            ...
            //Perform test
            val actualResponse = Assertions.assertThrows(
                    AndroException::class.java) { androService.deleteUser(userIdBad) }
